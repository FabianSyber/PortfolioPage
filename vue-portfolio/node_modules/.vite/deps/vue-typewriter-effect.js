...
// node_modules/vue-typewriter-effect/dist/vue-typewriter-effect.js
  ...
  (function(V, F) {
    ...
    var V = { 75: function(s) {
      (function() {
        ...
        })(), h2 = 1e9 * process.uptime(), A = v - h2) : Date.now ? (s.exports = function() {
          return Date.now() - N;
      ...
      for (var N = d(75), v = typeof window > "u" ? d.g : window, A = ["moz", "webkit"], h2 = "AnimationFrame", g = v["request" + h2], w = v["cancel" + h2] || v["cancelRequest" + h2], C = 0; !g && C < A.length; C++)
        g = v[A[C] + "Request" + h2], w = v[A[C] + "Cancel" + h2] || v[A[C] + "CancelRequest" + h2];
      if (!g || !w) {
        var M = 0, R = 0, E = [];
        g = function(y) {
          if (E.length === 0) {
          ...
          return E.push({ handle: ++R, callback: y, cancelled: false }), R;
        }, w = function(y) {
          for (var S = 0; S < E.length; S++)
            E[S].handle === y && (E[S].cancelled = true);
        };
      }
    ...
    b.n = (s) => {
      ...
      for (var d in c)
        b.o(c, d) && !b.o(s, d) && Object.defineProperty(s, d, { enumerable: true, get: c[d] });
    }, b.g = (function() {
    ...
    return (() => {
      ...
      var A = "TYPE_CHARACTER", h2 = "REMOVE_CHARACTER", g = "REMOVE_ALL", w = "REMOVE_LAST_VISIBLE_NODE", C = "PAUSE_FOR", M = "CALL_FUNCTION", R = "ADD_HTML_TAG_ELEMENT", E = "CHANGE_DELETE_SPEED", y = "CHANGE_DELAY", S = "CHANGE_CURSOR", j = "PASTE_STRING", D = "HTML_TAG";
      function _(o, n) {
        var a = Object.keys(o);
      ...
      function x(o) {
        for (var n = 1; n < arguments.length; n++) {
          ...
          n % 2 ? _(Object(a), true).forEach(function(r) {
            l(o, r, a[r]);
      ...
      const re = (function() {
        function o(r, L) {
          ...
          if ((function(t, i) {
            ...
            return e.state.eventLoopPaused = false, e.runEventLoop(), e;
          }), l(this, "pause", function() {
            return e.state.eventLoopPaused = true, e;
            ...
            var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
            return d(t) ? e.typeOutHTMLString(t, i, true) : (t && e.addEventToQueue(j, { character: t, node: i }), e);
            ...
            if (e.state.eventLoop = c()(e.runEventLoop), !e.state.eventLoopPaused) {
              ...
              if (!(i <= (m = u.eventName === w || u.eventName === h2 ? e.options.deleteSpeed === "natural" ? v(40, 80) : e.options.deleteSpeed : e.options.delay === "natural" ? v(120, 160) : e.options.delay))) {
                ...
                switch (e.logInDevMode({ currentEvent: u, state: e.state, delay: m }), T) {
                  ...
                  case A:
                    ...
                    break;
                  case h2:
                    p.unshift({ eventName: w, eventArgs: { removingCharacterNode: true } });
                    break;
                  case C:
                  ...
                  case g:
                    ...
                    Y && H.push({ eventName: E, eventArgs: { speed: Y, temp: true } });
                    for (var ee = 0, ue = ie.length; ee < ue; ee++)
                      H.push({ eventName: w, eventArgs: { removingCharacterNode: false } });
                    Y && H.push({ eventName: E, eventArgs: { speed: e.options.deleteSpeed, temp: true } }), p.unshift.apply(p, H);
                    break;
                  case w:
...
var Ee = defineComponent({
  ...
  setup(f) {
    ...
    }), () => h(f.element, { id: "typewriter" }, `${f.strings[0]}`);
  }
});
export {
  Ee as default
};
//# sourceMappingURL=vue-typewriter-effect.js.map
